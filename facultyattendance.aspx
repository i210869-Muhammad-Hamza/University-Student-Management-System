  ...
  <div class="username">Hello <asp:TextBox ID="user" runat="server" Style="font-weight:bold; width: 250px;"></asp:TextBox>
   ...
   <main>
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Obtained Marks" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id">
           <%-- <ItemTemplate>
...
<div class="center">
    <asp:Button ID="btnRegister" runat="server" Text="Mark Attendance" CssClass="large-button" OnClick="btnRegister_Click" /><br />
</div>
        <br />
