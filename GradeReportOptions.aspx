<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeReportOptions.aspx.cs" Inherits="GradeReportOptions" %>
	...
	<table style="margin-left: 20%">
        ...
        <tr>
			...
			<td>Section</td>
			 ...
			 <but><asp:Button ID="Button7" runat="server" Text="Grade Report" CssClass="button3" OnClick="Button7_Click" /></but>
			 <but><asp:Button ID="Button8" runat="server" Text="Count Of Grades Report" CssClass="button3" OnClick="Button8_Click" /></but>
