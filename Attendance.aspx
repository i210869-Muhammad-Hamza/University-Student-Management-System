...
<div class="button-container">
    <asp:Button ID="btnFetchAttendance" runat="server" Text="Fetch Attendance" CssClass="custom-button" OnClick="btnFetchAttendance_Click" />
  ...
  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" style="margin: 10px auto; text-align: center; width: 80%">
    ...
    <Columns>
        <asp:BoundField DataField="lecture_no" HeaderText="Lecture no" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
        <asp:BoundField DataField="status" HeaderText="status" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
        <asp:TemplateField HeaderText="Date" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id">
            <ItemTemplate>
                <asp:Label ID="lblDate" runat="server" Text='<%# Eval("date_") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
