  ...
  <div class="username">Hello <asp:TextBox ID="user" runat="server" Style="font-weight:bold; width: 250px;"></asp:TextBox>
   ...
   <main>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="F" HeaderText="Final Exam Absolutes" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
         <asp:BoundField DataField="S1" HeaderText="Sessional 1 Absolutes" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
        <asp:BoundField DataField="S2" HeaderText="Sessional 2 Absolutes" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
        <asp:BoundField DataField="A" HeaderText="Assignments" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
      <asp:BoundField DataField="Q" HeaderText="Quizzes" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
        <asp:BoundField DataField="T" HeaderText="Total Absolutes" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
