<%@ Page Language="C#" AutoEventWireup="true" Codefile="Grader.aspx.cs" Inherits="Grader" %>
	...
	<table style="margin-left: 20%">
        ...
        <tr>
			...
			<td>Section</td>
			 ...
			 <but><asp:Button ID="Button7" runat="server" Text="Generate Grades" style="font-size:15px" CssClass="button3" OnClick="Button7_Click" /></but>
