<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CountGradeReport.aspx.cs" Inherits="CountGradeReport" %>
  ...
  <div class="username">Hello <asp:TextBox ID="user" runat="server" Style="font-weight:bold; width: 250px;"></asp:TextBox>
   ...
   <main>
    ...
    <Columns>
        ...
        <asp:BoundField DataField="count" HeaderText="Count" HeaderStyle-CssClass="header-text" ItemStyle-CssClass="course-id" />
