<%@ Page Language="C#" AutoEventWireup="true" CodeFile="academic-officer.aspx.cs" Inherits="academic_officer" %>
...
<body>
    ...
    <SUBMIT_BUTTON>
		<asp:Button ID="btnSubmit" runat="server" CssClass="button" style="font-size: 20px;margin-left:220px; text-align: center;" Text="Submit" OnClick="btnSubmit_Click" />
            ...
            <br /><br /><br />
    <div>
    <a style="font-size: 20px;margin-left:220px; text-align: center" ; href="academic_officer_signup.aspx">If you are a new User SignUp now!</a>
    </div>
        </admin-login-form>
